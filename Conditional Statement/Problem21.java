...
public class Problem21 {
    public static void main(String[] args) {
        ...
        double parkingHours = sc.nextDouble();sc.nextLine();
        ...
        rawFee = (baseRate * (1 + zonePremium / 100.0) + vehicleSurcharge) * parkingHours;
        ...
        finalFee = rawFee * (1 - membershipDiscount / 100.0);
